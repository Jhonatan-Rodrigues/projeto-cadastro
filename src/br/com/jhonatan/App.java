...
import br.com.jhonatan.dao.ClienteMapDao;
import br.com.jhonatan.dao.ClienteSetDao;
    ...
    public class App {
        ...
        private static void cadastrar(String dados) {
            ...
            if (isCadastrado) {
                ...
                JOptionPane.showMessageDialog(null, "Cliente já cadastrado em nosso sistema! ", "Atenção", JOptionPane.INFORMATION_MESSAGE);
            }
        }
        ...
        private static void consultar(String dados) {
            ...
            if (cliente != null) {
                ...
                JOptionPane.showMessageDialog(null, "Cliente não foi encontrado: ", "Atenção!", JOptionPane.INFORMATION_MESSAGE);
            }
        }
